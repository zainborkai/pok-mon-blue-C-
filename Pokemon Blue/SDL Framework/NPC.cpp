...
NPC::NPC() :
	AnimatedTexture("NPC#1.png", 0, 0, 32, 32)
{
	AssignData(0, 0, 32, 32, 1, 1.0f, HORIZONTAL);
...
NPC::NPC(std::string filename, int x, int y, int w, int h, int frameCount, float animationSpeed, ANIM_DIR animationDir) :
	AnimatedTexture(filename, x, y, w, h) {
	AssignData(x, y, w, h, frameCount, animationSpeed, animationDir);
