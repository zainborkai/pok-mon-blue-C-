...
Game::Game() {
	...
	oInput = new InputManager();
	oWindow = new Window(*oGraphics, 0, 12, 32, 6);
	// examples 
	//oTileset = new Tileset(*oGraphics, "gtx/tilesets/pokecenter.png", "sprites/tilesets/pokecenter.tilecol");
	//oTileset = new Tileset(*oGraphics, "gfx/tilesets/overworld.png", "sprites/tilesets/overworld.tilecol");
	...
	//oPlayer = new Player(*oGraphics, 4, 25, "sprites/sprites/red.png");
	//oCamera = new Camera();
	//oText = new Text(*oGraphics, "sprites/font.png");
	//oNPC["BOY"] = new NPC(*oGraphics, 21, 30, "sprites/sprites/boy.png", "What's up?");
